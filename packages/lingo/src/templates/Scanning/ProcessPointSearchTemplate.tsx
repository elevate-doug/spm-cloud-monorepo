...
import { Button, Dropdown, SearchField } from '../../components/inputs'
...
export type ProcessPointSearchTemplateProps = {
  searchText: string
  siteValue: string
...
export const ProcessPointSearchTemplate: FC<
  ProcessPointSearchTemplateProps
> = ({
